(() => {
  // Compatibility/style layer only.
  // The actual audited device-analysis matching now lives in measurement-map-device-link-audit.js.
  // Keeping this file lightweight avoids competing MutationObservers during page load.
  ...
  function removeOutsideLegacyBlocks() {
  ...
  function run() {
    installStyles();
    if (document.getElementById("measurementMap")?.classList.contains("active")) removeOutsideLegacyBlocks();
  }

  document.addEventListener("DOMContentLoaded", run, { once: true });
  window.addEventListener("measurementMapTabsRebuilt", () => requestAnimationFrame(run));
  run();
})();
