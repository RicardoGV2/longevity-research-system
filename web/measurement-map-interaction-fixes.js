(() => {
  ...
  function installTabsMouseScroll() {
    document.querySelectorAll(".tabs").forEach((tabs) => {
      if (tabs.dataset.mouseScrollInstalled === "1") return;
      ...
      const canScrollHorizontally = () => tabs.scrollWidth > tabs.clientWidth + 2;
      const reset = () => {
        pointerId = null;
        dragged = false;
